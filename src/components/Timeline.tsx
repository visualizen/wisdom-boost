...
const Timeline = () => {
  ...
  return <section className="py-24 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 opacity-50">
        <img src="/src/assets/cargo-ship-bg.png" alt="" className="w-full h-full object-cover" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-primary-light via-primary to-primary-dark bg-clip-text text-gray-200 md:text-6xl">
            Linha do Tempo
          </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mb-20">
            <div className="flex justify-between items-start gap-4">
              {topSteps.map((step, index) => <div key={index} className="flex flex-col items-center animate-fade-in-up group flex-1" style={{
              animationDelay: `${index * 0.1}s`
                  ...
                  <div className="w-0.5 h-16 bg-white animate-line-grow-vertical origin-top" style={{
            ...
            {/* Horizontal Line */}
            <div className="absolute top-10 left-0 w-full h-1 bg-white animate-line-grow-horizontal origin-left" style={{
            animationDelay: `${topSteps.length * 0.3 + 0.5}s`
          }} />
          </div>
          ...
          minHeight: '220px'
            ...
            {bottomSteps.map((step, index) => <div key={index} className="flex flex-col items-center animate-fade-in-up group absolute" style={{
            ...
            top: '0'
                ...
                <div className="w-0.5 h-40 bg-white animate-line-grow-vertical origin-top absolute" style={{
